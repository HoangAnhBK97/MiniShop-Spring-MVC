				...
				<div class="tables">
					<div class="bs-example widget-shadow" data-example-id="bordered-table"> 
						...
						<div style="float:right; margin-bottom:10px;">
							<button id="btn-delete-2" class="btn btn-danger">XÓA</button>
						</div>
							...
							<thead> 
							 ...
							 <tbody>
							 	<c:forEach var="hoadon" items="${listHoaDon }">
							 		<tr> 
									 	 <th scope="row"><label><input class="cbHoaDon" type="checkbox" value="${hoadon.getIdhoadon() }"></label></th>
									 	 ...
									 	 <td><a href='<c:url value="/admin/hoadon/${hoadon.getIdhoadon() }"/>'><button class="btn btn-primary">Sửa</button></a></td>
								 	 </tr>
							 	</c:forEach> 
				 	 		</tbody> 
			 	 		</table>
